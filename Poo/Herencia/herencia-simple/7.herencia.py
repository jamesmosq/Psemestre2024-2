...
class Carro(Vehiculo):
  def __init__(self, marca, modelo, año, color, kilometraje, tipo_carroceria,tipo_motor):
...
class Brinks(Vehiculo):
  def __init__(self, marca, modelo, año, color, kilometraje, capacidad_bolsas):
    super().__init__(marca, modelo, año, color, kilometraje)
    self.capacidad_bolsas = capacidad_bolsas


carro1 = Carro("Toyota", "Corolla", 2020, "Rojo", 50000, "Sedan","Electrico")
